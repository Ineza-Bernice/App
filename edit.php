...
<body>
    <nav class="navbar nav-light justify-content-center fs-3 mb-5" style="background-color: #00ff5573;">
        PHP Complete CRUD Application
    </nav>
    <div class="container">
        <div class="text-center mb-4">
            <h3>Edit User Information</h3>
            <p class="text-muted"> Click after changing any information</p>
        </div>
        <?php
        ...
        ?>
            <div class="container d-flex justify-content-center">
                <form action="" method="post" style="width:50vw; min-width 300px;"><div class="row mb-3">
                    <div class="col">
